...
import cn.loblok.upc.modules.mall.enums.UserItemSourceType;
...
public class DeliveryServiceImpl implements DeliveryService {
    ...
    @Override
    public void deliverPhysical(FlashSaleOrders order) {
...
//         后续由运营/WMS系统处理发货
    ...
    @Override
    public void deliverVirtual(FlashSaleOrders order, Products product) {
    ...
    @Override
    public void deliverVoucher(FlashSaleOrders order, Products product) {
...
//           couponService.issueDiscountCoupon(userId, discount, scope, sourceId);
    ...
    @Override
    public void deliverThirdPartyVirtual(FlashSaleOrders order, Products product) {
        // 标记为“外部发放中”
