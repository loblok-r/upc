...
import cn.loblok.upc.common.enums.CouponStatus;
import cn.loblok.upc.common.enums.CouponTemplateType;
...
public class UserCouponServiceImpl extends ServiceImpl<UserCouponMapper, UserCoupon> implements UserCouponService {
    ...
    public void grantWelcomeCoupons(Long userId, IssueContext context) {
        ...
        List<String> templateCodes = Arrays.asList(
                ...
                CouponTemplateType.HD_One_Time_Experience.getTemplateCode(),
