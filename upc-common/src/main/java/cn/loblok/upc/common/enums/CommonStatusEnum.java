...
public enum CommonStatusEnum {
    ...
    CONSUME_COMPUTINGPOWER_FAIL(1712,"算力扣减失败"),
    ADD_COMPUTEPOWER_ERROR(1713,"算力值增加失败"),
    REDUCE_POINTS_FAIL(1714,"积分扣减失败"),

    ADD_POINTS_FAIL(1715,"积分增加失败"),
    ORDER_UPDATE_ERROR (1716,"订单状态更新失败"),
    EXTEND_VIP_ERROR(1717,"会员延长失败"),
    INSUFFICIENT_POINTS(1718,"积分不足");
